...
const Button = (props) => {
    ...
    const styleClass = {
        primary: {
            button: cx(
                'focus:shadow-[0_0_0_4px] bg-pwa-button_background hover:bg-pwa-button_background_hover focus:shadow-primary-300 ',
        ...
        secondary: {
            button: 'focus:shadow-[0_0_0_4px] bg-primary-100 hover:bg-primary-200 focus:shadow-primary-300 active:bg-primary-200',
            typography: cx('!text-primary group-active:!text-neutral-white', underline && 'underline'),
        },
        tertiary: {
            button: cx(
                'focus:shadow-[0_0_0_4px] bg-neutral-white',
