    ...
    const CustomerFooter = (params) => {
        ...
        return (
            <div className="flex flex-col gap-2 tablet:gap-4">
                ...
                <div className="hidden tablet:flex desktop:flex flex-row gap-1 items-center w-full justify-center">
            ...
            <>
                ...
                <div
                    className={classNames(
                        ...
                        'border border-neutral-50 rounded-lg p-2 lg:p-4 bg-neutral-white',
                ...
                >
                    <div className="w-full relative group overflow-hidden">
                        ...
                        {isOos && (
                            <div className={classNames('absolute top-2 tablet:top-3 left-2 tablet:left-3 z-10')}>
                                <Badge bold label={stockStatus.replace(/_/g, ' ')} className="text-white !text-xs tablet:!text-sm" />
                            </div>
                        )}
                        {showQuickView && (
                            <>
                        ...
                        <Show when={showWishlist || showProductCompare}>
                            <div className="flex-row gap-1 hidden tablet:flex desktop:hidden justify-center absolute
                            -translate-x-2/4 left-2/4 bottom-0 group-hover:block"
                            >
                                <Show when={showWishlist && !usedInWishlist}>
                                    <Button
                                        ...
                                        className={classNames(
                                            ...
                                            'hover:!shadow-none focus:!shadow-none opacity-80',
                                        )}
                                    />
                                </Show>
                    ...
                    <div className="pt-4 relative flex flex-col gap-4 flex-1 text-center">
                        ...
                        <Show when={showOption}>
                            <div className="hidden tablet:flex desktop:flex flex-col gap-2 tablet:gap-4 h-full justify-between [&_div]:items-center">
                                <ConfigurableOpt
                                    t={t}
                                    data={{
                                        ...other,
